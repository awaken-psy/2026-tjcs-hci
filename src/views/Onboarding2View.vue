...
<template>
  <ScreenView>
    ...
    <div class="onboarding-illustration">
      <TrendIcon class="illustration-icon" />
    </div>

    <div class="text-center">
      <p class="meta step">STEP 2 OF 2</p>
      <h1 class="headline">AI 实时反馈与评分</h1>
      <p class="desc">面试结束后获得结构化评分报告，包含表达能力、逻辑思维、专业知识等 6 大维度分析。</p>
    </div>
