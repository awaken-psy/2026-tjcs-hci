...
export default function DeviceFrame({ children }: { children: ReactNode }) {
  return (
    <div className="device">
      <span className="btn-rail left-1" aria-hidden="true" />
      <span className="btn-rail left-2" aria-hidden="true" />
      <span className="btn-rail left-3" aria-hidden="true" />
      <span className="btn-rail right-1" aria-hidden="true" />
